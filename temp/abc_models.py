...
def abc_alpha_inference(baseline_sig, healthy_profile, sbs88_profile, N_muts, hdi_mass = 0.9,
    ...
    alpha0, alpha1, total_mass = hdi(alpha_acceptances, alpha_range, mass = hdi_mass)
    ...
    return alpha_acceptances, alpha_range, alpha0, alpha1, hdi_mass
...
def hdi(acceptances, alpha_range, mass = 0.9):
    ...
    return alpha0, alpha1, total_mass